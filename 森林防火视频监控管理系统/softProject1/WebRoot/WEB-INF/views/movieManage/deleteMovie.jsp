...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_movielist?t="+new Date().getTime(),
	        idField:'mid', 
	        ...
	        columns: [[  
				...
				{field:'mid',title:'视频编号',width:150, sortable: true},
 		        {field:'mname',title:'视频名称',width:150},    
 		        {field:'mdate',title:'视频拍摄时间',width:150},
 		        {field:'mpaddress',title:'视频播放地址',width:150},
 		        {field:'mdaddress',title:'视频缩略图地址',width:150},
 		        {field:'mtype',title:'视频类型',width:150},    
 		        {field:'mlocation',title:'拍摄视频的监控点编号',width:150},
 		        {field:'muid',title:'值班人员编号',width:150},		        
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
