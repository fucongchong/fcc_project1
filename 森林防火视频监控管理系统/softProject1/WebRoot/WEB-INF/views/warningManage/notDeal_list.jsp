...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_notDealList?t="+new Date().getTime(),
	        idField:'aid', 
	        ...
	        columns: [[  
				...
				{field:'aid',title:'报警记录编号',width:150, sortable: true},
 		        {field:'adate',title:'报警时间',width:150},    
 		        {field:'ax',title:'火点横轴坐标',width:150},
 		        {field:'ay',title:'火点纵轴坐标',width:150},
 		        {field:'astatus',title:'状态',width:150},
 		        {field:'apoid',title:'产生报警的监控点ID',width:150},    
 		        {field:'aangle',title:'监控点旋转角度',width:150},
 		        {field:'auid',title:'巡值员工编号',width:150},
 		        {field:'aeid',title:'用户编号',width:150},
 		        {field:'aemessage',title:'专家留言',width:150},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
