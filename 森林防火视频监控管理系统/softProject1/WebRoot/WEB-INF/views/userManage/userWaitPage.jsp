...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_waitlist?t="+new Date().getTime(),
	        idField:'uid', 
	        ...
	        columns: [[  
				...
				{field:'uid',title:'用户编号',width:150, sortable: true},
 		        ...
 		        {field:'upwd',title:'用户密码',width:150},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	$.messager.alert("消息提醒", "请选择某一些通过审核", "warning");
            } else{
            	var ids = [];
            	$(selectRows).each(function(i, row){
            		ids[i] = row.uid;
            	});
            	$.messager.confirm("消息提醒", "您确定通过审核吗？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			<a id="delete" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-some-delete',plain:true">通过审核</a>
