...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_loginfolist?t="+new Date().getTime(),
	        idField:'lid', 
	        ...
	        columns: [[  
				...
				{field:'lid',title:'日志编号',width:150, sortable: true},
 		        {field:'llevel',title:'日志级别',width:150},    
 		        {field:'ldate',title:'日志生成时间',width:150},
 		        {field:'lcontent',title:'日志内容',width:150},		                
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
